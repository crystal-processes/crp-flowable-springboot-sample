...
[AcmeAiConfiguration.java](https://github.com/crystal-processes/crp-flowable-springboot-sample/blob/58f894e01bf73aab6847230d70de3ff61aecbdd5/src/main/java/org/crp/flowable/springboot/sample/AcmeAiConfiguration.java#L19-L33)

The `startProcessMessageHandler` is responsible for sending a message to the appropriate process:  
[StartProcessMessageHandler.java](https://github.com/crystal-processes/crp-flowable-springboot-sample/blob/58f894e01bf73aab6847230d70de3ff61aecbdd5/src/main/java/org/crp/flowable/springboot/sample/services/impl/StartProcessMessageHandler.java#L35-46)
...
[P005-aiMessageInputHandler.bpmn](https://github.com/crystal-processes/crp-flowable-springboot-sample/blob/58f894e01bf73aab6847230d70de3ff61aecbdd5/src/main/model/acme/P005-aiMessageInputHandler.bpmn#L9-L10)
...
1. **`system`** – Describes [the general purpose of the task](https://github.com/crystal-processes/crp-flowable-springboot-sample/blob/58f894e01bf73aab6847230d70de3ff61aecbdd5/src/main/model/acme/P005-aiMessageInputHandler.bpmn#L16) in a human-readable way.
...
[AiMessageInputHandlerTest.groovy](https://github.com/crystal-processes/crp-flowable-springboot-sample/blob/bf8736bc51c6a474674253b96b383935fbb00ced/src/test/groovy/org/crp/flowable/springboot/sample/ai/AiMessageInputHandlerTest.groovy#L83-L91)

The task's output:  
[chatClient-happy-response.json](https://github.com/crystal-processes/crp-flowable-springboot-sample/blob/bf8736bc51c6a474674253b96b383935fbb00ced/src/test/resources/chatClient-happy-response.json#L1-L13)
