 ...
 * @since 1.0.0
 */
public class IdentityAwarePgVectorStore extends AbstractObservationVectorStore implements InitializingBean {
     ...
     */
    protected IdentityAwarePgVectorStore(PgVectorStoreBuilder builder) {
        super(builder);
    ...
    public static final class PgVectorStoreBuilder extends AbstractVectorStoreBuilder<PgVectorStoreBuilder> {
        ...
        private PgIdType idType = IdentityAwarePgVectorStore.DEFAULT_ID_TYPE;
        ...
        public IdentityAwarePgVectorStore build() {
            return new IdentityAwarePgVectorStore(this);
        }
